...
class M_products extends CI_Model
{
    ...
    function validate()
    {
        ...
        $this->form_validation->set_rules('SKU', 'SKU', 'required|callback_sku_check');
        $this->form_validation->set_rules('friendly_url', 'Friendly Url', 'required|callback_friendly_url_check');
