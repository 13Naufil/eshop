 ...
 * @copyright 2019 * @date 06-10-2019
 */
if (!defined('BASEPATH')) exit('No direct script access allowed');

class M_product_rating_types extends CI_Model
{

    var $table = 'product_rating_types';
    var $id_field = 'id';
...
/* End of file m_product_rating_types.php */
/* Location: ./application/models/m_product_rating_types.php */