...
if (!defined('FILE_CACHE_PREFIX')) define ('FILE_CACHE_PREFIX', ''); // What to put at the beg of all files in the cache directory so we can identify them
if (!defined('FILE_CACHE_DIRECTORY')) define ('FILE_CACHE_DIRECTORY', APPPATH . 'cache'); // Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
...
/* Location: ./application/libraries/Timthumb.php */