                ...
                success: 
                    function(response){
                        ...
                        for(i=0;i<response.length;i++){
                             $(".productdd").append("<option value='"+response[i].id+"' style='background-image:url(http://emerce.pk/thumbs/assets/front/products/"+response[i].image+");'>"+response[i].name+", "+response[i].SKU+"</option>")
                        }
