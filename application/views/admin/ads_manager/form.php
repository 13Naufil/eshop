    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                <label class="col-sm-2 control-label text-right">Location : <span class="mandatory">*</span></label>
                <div class="col-sm-7">
                    <input type="text" name="location" id="location" class="form-control  validate[required]"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <textarea name="content" id="content" cols="100" rows="30" class="form-control editor  col-sm-12"><?php echo $row->content; ?></textarea>
                </div>
            </div>
            <div class="form-group">
