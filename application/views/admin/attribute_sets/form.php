    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                <label class="col-sm-2 control-label text-right">Set Title : <span class="mandatory">*</span></label>
                <div class="col-sm-7">
                    <input type="text" name="set_title" id="set_title" class="form-control  validate[required]"
                        value="<?php echo $row->set_title ?>"/>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input type="text" name="ordering" id="ordering"
                        class="form-control  validate[required,custom[integer]]" value="<?php echo $row->ordering ?>"/>
                </div>
            </div>
