 ...
 * @copyright 2019 * @date 03-06-2019 */
...
$grid->form_buttons = array('new', 'edit', 'delete', 'view', 'refresh', 'print', 'import');
$grid->grid_buttons = array('edit', 'files', 'view', 'account', 'status', 'delete');
echo $grid->showGrid();
?>
