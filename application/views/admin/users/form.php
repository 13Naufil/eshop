    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <select name="user_type_id" id="user_type_id" class="select validate[required]">
                        <option value="">-- Select --</option>
                         <?=selectBox("SELECT * FROM user_types",$row->user_type_id); ?>
                    </select>
                </div>
            </div>
...
<script>
    ...
    $('#user_type_id').live('click', function () {
