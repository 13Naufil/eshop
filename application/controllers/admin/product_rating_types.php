 ...
 * @property M_product_rating_types $m_product_rating_types * @copyright 2019 * @date 06-10-2019
 */
if (!defined('BASEPATH')) exit('No direct script access allowed');

class Product_rating_types extends CI_Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method product_rating_types __construct
     * @model product_rating_types main_model    | m_product_rating_types
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method product_rating_types index | Grid | listing
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method product_rating_types form
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method product_rating_types view
     * *****************************************************************************************************************
     */
    public function view()
    {
        ...
        activity_log('view_product_rating_types', $this->table, $id);
    ...
    public function add()
    {
        if (!$this->module->validate()) {
            ...
            activity_log('create_product_rating_types', $this->table, $id);
    ...
    public function update()
    {
        ...
        if (!$this->module->validate()) {
            ...
            activity_log('update_product_rating_types', $this->table, $id);
    ...
    function delete()
    {
        ...
        activity_log('view_product_rating_types', $this->table, explode(',', $id));
...
/* End of file product_rating_types.php */
/* Location: ./application/controllers/admin/product_rating_types.php */