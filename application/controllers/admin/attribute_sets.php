 ...
 * @property M_attribute_sets $m_attribute_sets * @copyright 2019 * @date 25-08-2019
 */
if (!defined('BASEPATH')) exit('No direct script access allowed');

class Attribute_sets extends CI_Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method attribute_sets __construct
     * @model attribute_sets main_model    | m_attribute_sets
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method attribute_sets index | Grid | listing
     * *****************************************************************************************************************
     */
    ...
    public function view()
    {
        ...
        activity_log('view_attribute_sets', $this->table, $id);
    ...
    public function add()
    {
        if (!$this->module->validate()) {
            ...
            activity_log('create_attribute_sets', $this->table, $id);
    ...
    public function update()
    {
        ...
        if (!$this->module->validate()) {
            ...
            activity_log('update_attribute_sets', $this->table, $id);
    ...
    function delete()
    {
        ...
        activity_log('view_attribute_sets', $this->table, explode(',', $id));
...
/* End of file attribute_sets.php */
/* Location: ./application/controllers/admin/attribute_sets.php */