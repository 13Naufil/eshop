 ...
 * @property M_ads_manager $m_ads_manager * @copyright 2019 * @date 06-10-2019
 */
if (!defined('BASEPATH')) exit('No direct script access allowed');

class Ads_manager extends CI_Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method ads_manager __construct
     * @model ads_manager main_model    | m_ads_manager
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method ads_manager index | Grid | listing
     * *****************************************************************************************************************
     */
    ...
    public function index()
    {
        ...
        $where = '';
        $query = "SELECT `id`, `location`, `status`, `created` FROM {$this->table} WHERE 1 " . $where;
    ...
    public function view()
    {
        ...
        activity_log('view_ads_manager', $this->table, $id);
    ...
    public function add()
    {
        if (!$this->module->validate()) {
            ...
            activity_log('create_ads_manager', $this->table, $id);
    ...
    public function update()
    {
        ...
        if (!$this->module->validate()) {
            ...
            activity_log('update_ads_manager', $this->table, $id);
    ...
    function delete()
    {
        ...
        activity_log('view_ads_manager', $this->table, explode(',', $id));
...
/* End of file ads_manager.php */
/* Location: ./application/controllers/admin/ads_manager.php */