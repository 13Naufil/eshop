 ...
 * @property M_cms_where_to_buy $m_cms_where_to_buy * @copyright 2019 * @date 20-10-2019
 */
if (!defined('BASEPATH')) exit('No direct script access allowed');

class Cms_where_to_buy extends CI_Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method cms_where_to_buy __construct
     * @model cms_where_to_buy main_model    | m_cms_where_to_buy
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method cms_where_to_buy index | Grid | listing
     * *****************************************************************************************************************
     */
    ...
    public function view()
    {
        ...
        activity_log('view_cms_where_to_buy', $this->table, $id);
    ...
    public function add()
    {
        if (!$this->module->validate()) {
            ...
            if(getVar('lat') == '' || getVar('lng') == ''){
                $lat_lang = getLatLng(getVar('business_address') . ', ' . getVar('city') . ', ' . getVar('country'));
            ...
            activity_log('create_cms_where_to_buy', $this->table, $id);
    ...
    public function update()
    {
        ...
        if (!$this->module->validate()) {
            ...
            activity_log('update_cms_where_to_buy', $this->table, $id);
    ...
    function delete()
    {
        ...
        activity_log('view_cms_where_to_buy', $this->table, explode(',', $id));
    ...
    public function import()
    {
        ...
        if (getVar('import')) {
            ...
            $import->cols_custom_func = array('lat' => 'get_lat','lng' => 'get_lat');
...
/* End of file cms_where_to_buy.php */
/* Location: ./application/controllers/admin/cms_where_to_buy.php */