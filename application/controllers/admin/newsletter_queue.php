 ...
 * @property M_newsletter_queue $m_newsletter_queue * @copyright 2019 * @date 13-08-2019
 */
if (!defined('BASEPATH')) exit('No direct script access allowed');

class Newsletter_queue extends CI_Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method newsletter_queue __construct
     * @model newsletter_queue main_model    | m_newsletter_queue
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method newsletter_queue index | Grid | listing
     * *****************************************************************************************************************
     */
    ...
    public function index()
    {
        ...
        $where = '';
        replace_find_query('email_template', 'email_templates.name', $where);

        $query = "SELECT newsletter_queue.id,
          newsletter_queue.start_date,
          newsletter_queue.end_date,
          email_templates.name AS email_template,
          newsletter_queue.processed,
          newsletter_queue.status FROM newsletter_queue
          INNER JOIN email_templates ON email_templates.id = newsletter_queue.email_template_id
          WHERE 1 " . $where;
    ...
    public function view()
    {
        ...
        activity_log('view_newsletter_queue', $this->table, $id);
    ...
    public function add()
    {
        if (!$this->module->validate()) {
            ...
            activity_log('create_newsletter_queue', $this->table, $id);
    ...
    public function update()
    {
        ...
        if (!$this->module->validate()) {
            ...
            activity_log('update_newsletter_queue', $this->table, $id);
    ...
    function delete()
    {
        ...
        activity_log('view_newsletter_queue', $this->table, explode(',', $id));
...
/* End of file newsletter_queue.php */
/* Location: ./application/controllers/admin/newsletter_queue.php */