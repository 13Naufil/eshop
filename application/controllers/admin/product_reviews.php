 ...
 * @property M_product_reviews $m_product_reviews * @copyright 2019 * @date 13-10-2019
 */
...
class Product_reviews extends CI_Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method product_reviews __construct
     * @model product_reviews main_model    | m_product_reviews
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method product_reviews index | Grid | listing
     * *****************************************************************************************************************
     */
    ...
    public function view()
    {
        ...
        activity_log('view_product_reviews', $this->table, $id);
    ...
    public function add()
    {
        ...
        if (!$this->module->validate()) {
            ...
            $DbArray['customer_ip'] = $this->input->server('REMOTE_ADDR');
            $DbArray['customer_user_agent'] = $this->input->server('HTTP_USER_AGENT');

            $id = save($this->table, $DBdata);
            activity_log('create_product_reviews', $this->table, $id);
    ...
    public function update()
    {
        ...
        if (!$this->module->validate()) {
            ...
            $DbArray = getDbArray($this->table);
            $DBdata = $DbArray['dbdata'];
            $DBdata['recommend'] = getVar('recommend');
            $where = $DbArray['where'];
            save($this->table, $DBdata, $where);
            activity_log('update_product_reviews', $this->table, $id);
    ...
    function delete()
    {
        ...
        activity_log('view_product_reviews', $this->table, explode(',', $id));
