 ...
 * @property M_subscribers $m_subscribers * @copyright 2019 * @date 13-08-2019
 */
...
class Subscribers extends CI_Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method subscribers __construct
     * @model subscribers main_model    | m_subscribers
     * *****************************************************************************************************************
     */
    ...
    public function index()
    {
        ...
        $where = '';
        replace_find_query('type', "IFNULL(customers.customer_type, 'Guest')", $where);

        $query = "SELECT subscribers.id, IFNULL(customers.customer_type, 'Guest') AS `type`, subscribers.name,subscribers.email,subscribers.status FROM subscribers
        LEFT JOIN customers ON customers.id = subscribers.customer_id
        WHERE 1 " . $where;
    ...
    public function view()
    {
        ...
        activity_log('view_subscribers', $this->table, $id);
    ...
    public function add()
    {
        if (!$this->module->validate()) {
            ...
            activity_log('create_subscribers', $this->table, $id);
    ...
    public function update()
    {
        ...
        if (!$this->module->validate()) {
            ...
            activity_log('update_subscribers', $this->table, $id);
    ...
    function delete()
    {
        ...
        activity_log('view_subscribers', $this->table, explode(',', $id));
