 ...
 * @property M_enquiries $m_enquiries * @copyright 2019 * @date 12-08-2019
 */
...
class Enquiries extends CI_Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method enquiries __construct
     * @model enquiries main_model    | m_enquiries     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method enquiries index | Grid | listing
     * *****************************************************************************************************************
     */
    ...
    public function index()
    {
        ...
        $query = "SELECT enquiries.id,
          ...
          enquiries.`created`,
          enquiries.`status` FROM {$this->table}
          LEFT JOIN products ON (products.id = enquiries.product_id)
           WHERE 1 " . $where;
...
FROM {$this->table}
 ...
 WHERE {$this->id_field}='{$id}'";
        ...
        activity_log('view_enquiries', $this->table, $id);
    ...
    public function add()
    {
        if (!$this->module->validate()) {
            ...
            activity_log('create_enquiries', $this->table, $id);
    ...
    public function update()
    {
        ...
        if (!$this->module->validate()) {
            ...
            activity_log('update_enquiries', $this->table, $id);
    ...
    function delete()
    {
        ...
        activity_log('view_enquiries', $this->table, explode(',', $id));
...
/* Location: ./application/controllers/admin/enquiries.php */