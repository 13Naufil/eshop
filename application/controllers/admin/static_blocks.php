 ...
 * @property M_static_blocks $m_static_blocks
 * @copyright 2019 * @date 18-09-2019
 */
if (!defined('BASEPATH')) exit('No direct script access allowed');

class Static_blocks extends CI_Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method static_blocks __construct
     * @model static_blocks main_model    | m_static_blocks     * *****************************************************************************************************************
     */
    ...
    public function index()
    {
        ...
        $query = "SELECT `id`,
          ...
          `block_identifier`,
          `status`,
          `created` FROM " . $this->table . " WHERE 1 " . $where;
    ...
    public function view()
    {
        ...
        activity_log('view_static_blocks', $this->table, $id);
    ...
    public function add()
    {
        if (!$this->module->validate()) {
            ...
            activity_log('create_static_blocks', $this->table, $id);
    ...
    public function update()
    {
        ...
        if (!$this->module->validate()) {
            ...
            activity_log('update_static_blocks', $this->table, $id);
    ...
    function delete()
    {
        ...
        activity_log('view_static_blocks', $this->table, explode(',', $id));
...
/* End of file static_blocks.php */
/* Location: ./application/controllers/admin/static_blocks.php */