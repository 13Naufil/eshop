...
class quick_order extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $where = '';
        $query = "SELECT o.id,o.customer_name as 'Customer Name',o.customer_email as 'Customer Email',o.customer_mobile as 'Customer Mobile',o.delivery_address as 'Delivery Address',o.delivery_city as 'Delivery City',p.name as 'Product Name',p.special_price as 'Product Price',o.size as 'Size',o.color as 'Color',o.order_date as 'Order Date',o.payment_method as 'Payment Method',o.status as 'Status' FROM " . $this->table . " o INNER JOIN `products` p on p.id=o.product_id WHERE 1 " . $where;
    ...
    public function add()
    {
        if (!$this->module->validate()) {
            ...
            $DBdata['payment_method'] = "Cash on Delivery";
