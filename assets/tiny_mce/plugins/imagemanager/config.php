<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = '../../../editor_img/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = '../../../editor_img/'; // absolute or relative from this script path, required.
